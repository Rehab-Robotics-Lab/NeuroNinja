...
const int beginG1 = 7;// 7; 
const int beginG2 = A2; // begin game 1
const int piezo = 10; // sound output

bool buttonG1Pressed = false;
bool buttonG2Pressed = false;
...
void loop() {
  ...
  //Start Game 1
  if (buttonStateG1 == HIGH && buttonG1Pressed == false && buttonG2Pressed == false) {
  ...
  //Start Game 2
  if (buttonStateG2 == HIGH && buttonG2Pressed == false && buttonG1Pressed == false) {
    // Button is pressed and wasn't pressed before
